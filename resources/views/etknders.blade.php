            ...
            <div class="profile-content">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- Form -->
                        <form action="{{ url('/etkndrs')}}" method="POST" class="form-horizontal">
                            {{ csrf_field() }}
                            <!-- drs adı -->
                            ...
                            <div class="col-sm-6">
                                 <select class="selectpicker form-control"  data-live-search="true" name="ad" >
                         @foreach($dersler as $drs)                           
                                  <option value="{{ $drs->id }}">{{$drs->ders_adi}}</option>
                            @endforeach
